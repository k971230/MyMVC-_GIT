...
// import org.eclipse.jdt.internal.compiler.parser.RecoveredRequiresStatement; 혹시 안되면 이거 풀어볼것 
...
public class SmsSendAction extends AbstractController {
    ...
    //String api_key = "발급받은 본인의 API Key";  // 발급받은 본인 API Key
		String api_key = " NCSA2J3KKBAXANKT"; // 내꺼
	//String api_secret = "발급받은 본인의 API Secret";  // 발급받은 본인 API Secret
		String api_secret = "D9HDYGVLQRYFOKOS4HOAGUKDGTCRZWUJ"; //내꺼
	    ...
	    paraMap.put("from", "01097370275"); // 발신번호
